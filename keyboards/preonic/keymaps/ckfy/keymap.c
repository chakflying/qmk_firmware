 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Reset|      |      |      |GUI On|GUIOff|TermON|TermOf|      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, RESET,   DEBUG,   CK_ON,  CK_OFF,  GUI_ON, GUI_OFF, TERM_ON, TERM_OFF,_______, _______, KC_DEL,
  RESET,  _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  _______, _______,
...
[_EXTRA] = LAYOUT_preonic_grid(
  ...
  _______, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS,   KC_PSCR, KC_NLCK,   KC_P1,   KC_P2,   KC_P3, KC_PDOT, _______,
