 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Reset| Debug|      |      |GUI On|GUIOff|Unicode|     |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, QK_BOOT, DB_TOGG,   CK_ON,  CK_OFF,  GUI_ON, GUI_OFF, UC_NEXT, _______,  _______, _______,  KC_DEL,
...
[_EXTRA] = LAYOUT_preonic_grid(
  KC_TILD, X(LAUGHCRY),    X(XD), X(WARM), X(ROFL), X(TEARSAD), X(CRYING), X(EXPLODE), X(SPEAKNOEVIL),  X(BOW),    KC_0,  KC_BSPC,
